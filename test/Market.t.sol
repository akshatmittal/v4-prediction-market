...
contract MarketTest is Test {
    ...
    function testFundMarket() public {
        ...
        assertEq(uint256(market.stage()), uint256(MarketData.Stages.MarketFunded));
    }
    ...
    function testCloseMarket() public {
        ...
        assertEq(uint256(market.stage()), uint256(MarketData.Stages.MarketClosed));
    }
    ...
    function testSellOutcomeTokens() public {
        ...
        collateralToken.approve(address(market), fundingAmount);
        uint256 profit = market.sell(0, 5, 1);
        vm.stopPrank();
        assertGt(profit, 0);
    }
